      ...
      <section className="py-16 bg-brand-paper">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-xl font-bold text-brand-primary mb-6 flex items-center gap-2">
            <ShieldCheck className="w-5 h-5 text-brand-accent" /> Before You Buy in the Sadashivpet Corridor
          </h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="mt-10 text-sm text-brand-muted">
            ...
            <Link href="/projects/vaibhav-county" className="font-semibold text-brand-primary hover:text-brand-accent">
