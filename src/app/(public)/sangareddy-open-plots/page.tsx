      ...
      <section className="relative overflow-hidden bg-brand-deep luxury-bg-grid-white pt-32 sm:pt-40 pb-16 sm:pb-20">
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight mb-6">
            Exclusive Open Plots in Sangareddy — <span className="text-brand-accent">HMDA & RERA Approved</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/?project=TJR%20Township#book-visit" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 gradient-gold text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all">
      ...
      <section className="py-16 bg-brand-paper">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-xl font-bold text-brand-primary mb-6 flex items-center gap-2">
            <ShieldCheck className="w-5 h-5 text-brand-accent" /> Before You Buy in the Sangareddy Corridor
          </h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="mt-10 text-sm text-brand-muted">
            ...
            <Link href="/projects/tjr-township" className="font-semibold text-brand-primary hover:text-brand-accent">
