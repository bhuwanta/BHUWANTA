...
export default function PoliciesPage() {
  ...
  return (
    <main className="min-h-screen bg-brand-paper pt-32 pb-20">
      <JsonLd data={breadcrumb} />
      <div className="max-w-4xl mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-16">
          <p className="text-sm font-semibold text-brand-accent mb-3 tracking-wider uppercase">Legal</p>
          <h1 className="text-4xl sm:text-5xl font-bold text-brand-deep mb-4">Terms & Privacy</h1>
          <p className="text-sm text-brand-muted">Last updated: {lastUpdated}</p>
        </div>

        {/* Quick Nav */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <a href="#privacy" className="flex items-center gap-4 p-6 bg-white rounded-2xl border border-brand-border hover:border-brand-gold/30 transition-premium group shadow-sm">
            <div className="w-12 h-12 rounded-xl bg-brand-gold/10 flex items-center justify-center text-brand-accent group-hover:scale-110 transition-premium">
              <Shield className="w-6 h-6" />
            </div>
            <div>
              <h3 className="font-semibold text-brand-deep">Privacy Policy</h3>
              <p className="text-xs text-brand-muted">How we protect your data</p>
            </div>
          </a>
          <a href="#terms" className="flex items-center gap-4 p-6 bg-white rounded-2xl border border-brand-border hover:border-brand-gold/30 transition-premium group shadow-sm">
            <div className="w-12 h-12 rounded-xl bg-brand-deep/5 flex items-center justify-center text-brand-deep group-hover:scale-110 transition-premium">
              <FileText className="w-6 h-6" />
            </div>
            <div>
              <h3 className="font-semibold text-brand-deep">Terms of Service</h3>
              <p className="text-xs text-brand-muted">Conditions of use</p>
            </div>
          </a>
        </div>
        ...
        <div className="space-y-12">
          {/* Privacy Policy */}
          <section id="privacy" className="bg-white rounded-3xl p-8 md:p-12 border border-brand-border shadow-sm">
            <div className="flex items-center gap-3 mb-8">
              <Shield className="w-5 h-5 text-brand-accent" />
              <h2 className="text-2xl font-bold text-brand-deep">Privacy Policy</h2>
            </div>
            ...
            <div className="space-y-6 text-sm text-brand-muted leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-brand-deep mb-2">2. How We Use It</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-brand-deep mb-2">3. Data Protection</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-brand-deep mb-2">4. Cookies</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-brand-deep mb-2">5. Your Rights</h3>
          ...
          {/* Terms of Service */}
          <section id="terms" className="bg-white rounded-3xl p-8 md:p-12 border border-brand-border shadow-sm">
            <div className="flex items-center gap-3 mb-8">
              <FileText className="w-5 h-5 text-brand-deep" />
              <h2 className="text-2xl font-bold text-brand-deep">Terms of Service</h2>
            </div>

            <div className="space-y-6 text-sm text-brand-muted leading-relaxed">
              <div>
                <h3 className="text-lg font-semibold text-brand-deep mb-2">1. Acceptance & General Disclaimer</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-brand-deep mb-2">3. Marketing Representations & Accuracy</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-brand-deep mb-2">4. Independent Verification & Advice</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-brand-deep mb-2">5. Limitation of Liability</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-brand-deep mb-2">6. Governing Law</h3>
