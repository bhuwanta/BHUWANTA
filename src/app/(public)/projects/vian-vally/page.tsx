...
export async function generateMetadata(): Promise<Metadata> {
  return buildProjectPageMetadata(config,
    'Vian Valley Villa Plots in Shabad | Bhuwanta',
    'Explore Vian Valley in Shabad with Bhuwanta. Request current plot prices and options, phase-specific documents and a site visit.'
  )
}
...
const config: ProjectLandingConfig = {
  ...
  opportunityParagraphs: [
    'Explore Vian Valley open plots in Shabad, Ranga Reddy district, with Bhuwanta.  Request the current plot list and a written quote for the size, facing and phase you prefer.',
  ...
  faqs: [
    {
      ...
      answer: 'Contact Bhuwanta for current Vian Valley prices. Request a plot-specific quote with dimensions, facing, phase and a breakdown of applicable charges.',
    },
    {
